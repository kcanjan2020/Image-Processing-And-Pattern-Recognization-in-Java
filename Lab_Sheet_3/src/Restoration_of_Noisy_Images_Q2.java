...
public class Restoration_of_Noisy_Images_Q2
{
	public static void main(String[] args)
	{
		...
		try
		{
			OrgImage=ImageIO.read(new File("D:\\Computer Engineering Note\\7th Sem\\2. Image Processing And Pattern Recognization\\IPPR_Lab_Solution\\messi.jpg"));
			image=ImageIO.read(new File("D:\\Computer Engineering Note\\7th Sem\\2. Image Processing And Pattern Recognization\\IPPR_Lab_Solution\\messi_N.jpg"));
